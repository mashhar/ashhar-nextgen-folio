...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ashhar Nadeem" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { name: "keywords", content: "Ashhar Nadeem, Data Consultant, AI Consultant, Artificial Intelligence Consultant, Technology Consultant, Digital Transformation Consultant, Data Strategy, Data Analytics, AI Strategy, Automation Consultant, Business Intelligence, Machine Learning Consultant" },
